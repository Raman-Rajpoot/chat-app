...
const { createGroupChat, getMyChats ,addMembersToGroup, removeMember,leaveGroup,sendAttachment,getChats, renameGroup,deleteChat, getMesasages,getChatDetails,deleteMessage} = chatController;
...
chatRouter.get("/get-chats/:chatId", Authorization, getChats);
...
chatRouter.delete("/delete-message", Authorization, deleteMessage);
